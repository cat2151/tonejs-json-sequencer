...
interface TimingStats {
  ...
  earlyEvents: number;
  loopCount: number;
  lastLoopStatus: string;
  lastLoopDriftMs: number | null;
}

function createInitialTimingStats(): TimingStats {
  return {
    totalEvents: 0,
    onTimeEvents: 0,
    lateEvents: 0,
...
export class DebugOutput {
  ...
  private timingStats: TimingStats = createInitialTimingStats();
   ...
   */
  handleMessage(message: string, data?: any): void {
