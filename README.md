...
📄 [Tone.js Components JSON Compatibility Roadmap (Detailed Version)](docs/tonejs-components-roadmap.ja.md)
...
- **Use Case Example**: Portamento, pitch envelope at attack time (-200 cents → 0 cents, etc.)
...
- Generating delay vibrato on and off for all notes → Similar to Node ID assignment.
- Other data processing within JSON → Similar to Node ID assignment.
