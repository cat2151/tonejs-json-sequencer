...
📄 [Tone.js Component JSON Support Roadmap (Detailed Version)](docs/tonejs-components-roadmap.ja.md)
...
# Out of Scope
- Node ID assignment → Handled by higher layers, e.g., tonejs-mml-to-json or a JSON post-processor at a lower layer.
