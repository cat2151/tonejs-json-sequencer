...
tonejs-json-sequencerは、その課題を解決します。あるいは解決を目指して開発中です。

ただし、検証サイクルを素早くまわすため割り切った思想で作られているため、tonejs-json-sequencerによるデータドリブンなオーディオグラフ構築には、いろいろな制約があるかもしれません。

なにが可能で、なにができないかは、以下がある程度参考になるかもしれません：
